...
差异化：**有状态 + 轻量 active memory + 主动感知 + Go 单二进制 + 多模型**。
...
| Phase | 内容 | 周期 |
|---|---|---|
| 1 | Daemon 基础 + 记忆层基础：sunad + IPC + active memory + memory_queue + 9 工具 + Guard stub | 5 周 |
| 2 | 行动层完善：Guard 完善 + 渐进信任 + 多模型路由 + 感知源 (Timer/Watcher/Webhook/Stream) | 4 周 |
| 3 | 记忆深化 + 学习：active memory 质量评估 + 程序记忆 (skill 学习) + 能力系统 (SKILL.md + JS + MCP) | 4 周 |
